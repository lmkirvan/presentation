...
:::{.notes}
This talk is pretty simple. The first part is about recognizing how important words are for communicating about data. Sure data visualizations are cool, but have you heard of paragraphs? But, seriously, I work in a reasonably data driven organization. Still I'd wager that basically none of the decision makers in my organization have run a regression (at least since college). Effective communication through 
